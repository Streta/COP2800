import java.sql.*;   // Needed for the JDBC classes

/**
   The CoffeeDBQuery class executes queries on the CoffeeDB 
   database and provides the results in arrays for the 
...
public class CoffeeDBQuery
{
   ...
   public CoffeeDBQuery(String query)
   {
      ...
      try
      {
         ...
         // Close the statement and connnection objects.
         stmt.close();
         conn.close();
      }
