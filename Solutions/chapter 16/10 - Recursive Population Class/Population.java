...
/**
   ...
   Recursive Population Class programming challenge.
*/
...
public class Population
{
   ...
   /**
      The displayPopulation method displays the
      population table header and then calls
      the recursive showPopulation method to
      display the daily populations.
      @param startingOrganisms The number of
             starting organisms in the population.
      @param increase The daily increase percentage.
      @param days The number of days the organisms
             will be left to multiply.
   */

   public static void displayPopulation(double startingOrganisms,
                                        double increase, int days)
   {
   ...
   /**
      The showPopulation method displays the daily
      populations for a group of organisms for a
      specified day, and then calls itself to display
      the data for the rest of the days in a time
      period.
   ...
   */
   ...
   private static void showPopulation(int dayNum, int days,
                                      double organisms,
