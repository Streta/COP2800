/**
   The BankAccount class stores data about a bank account for 
   the BankAccount Class Copy Constructor programming challenge.
*/
...
public class BankAccount
{
   ...
   */
   ...
   /**
      Copy constructor. This constructor accepts a
